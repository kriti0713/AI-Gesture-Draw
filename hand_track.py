...
# Standard 21-point hand connections (same layout MediaPipe uses internally)
HAND_CONNECTIONS = [
...
def draw_hand_skeleton(img, hand_landmarks, w, h):
    """Draws the full 21-point hand skeleton overlay (connections + joints)."""
...
while True:
    ...
    # draw full hand skeleton overlay for every detected hand
    ...
    cv2.imshow("AI Gesture Draw", combined)
